...
shell=(ROOT/'src/index.html').read_text(); css=(ROOT/'src/style.css').read_text()+'\n'+(ROOT/'src/campaign-builder.css').read_text()+'\n'+(ROOT/'src/workspace.css').read_text(); app=(ROOT/'src/app.js').read_text(); core=(ROOT/'src/core.js').read_text(); app=app.replace('/* CATALOG_EXTENSIONS */',(ROOT/'src/catalog-extensions.js').read_text()); app=(ROOT/'src/workspace-core.js').read_text()+'\n'+(ROOT/'src/campaign-core.js').read_text()+'\n'+app.replace('/* CAMPAIGN_BUILDER */',(ROOT/'src/campaign-builder.js').read_text()).replace('/* SHARED_WORKSPACE */',(ROOT/'src/workspace.js').read_text())
